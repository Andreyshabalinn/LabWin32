        ...
        private unsafe void button1_Click(object sender, EventArgs e)
        {
            ...
            switch (GetSystemMetrics(SystemMetric.SM_CLEANBOOT))
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    label5.Text = "Тип загрузки : " + "Fail safe boot with setworking";
                    break;
            }
